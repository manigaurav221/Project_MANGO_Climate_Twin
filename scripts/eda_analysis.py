...
axes[0, 0].set_title("Mean daily national rainfall total by month (2025)")
...
ax.set_title("Mean daily rainfall by grid cell (2025)")
...
ax.set_title("Mean max temperature by grid cell (2025)")
plt.tight_layout()
...
ax1.set_title("2025 daily national aggregates")
